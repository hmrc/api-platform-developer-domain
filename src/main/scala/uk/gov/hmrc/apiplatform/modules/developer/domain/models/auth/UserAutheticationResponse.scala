...
package uk.gov.hmrc.apiplatform.modules.developer.domain.models.auth

import play.api.libs.json.{Json, OFormat}

import uk.gov.hmrc.apiplatform.modules.developer.domain.models.session.UserSessionResponse
